...
@torch.no_grad()
def test(model, hn, hf, dataset, chunk_size=10, img_index=0, nb_bins=192, H=800, W=800):
    """
    Args:
...
if __name__ == '__main__':
    ...
    data_location = r"C:\Users\ravin\Downloads\tiny-nerf-main\tiny-nerf-main\chair"
